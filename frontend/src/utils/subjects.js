export const LESSONS = [
    ...
    { id: "soulbound-cert", name: "🎓 Bài 4: Bằng Khen & Danh Tính", blocks: ["wallet", "drop-airdrop", "profile-gallery"] },
    { id: "dex-exchange", name: "🦄 Bài 5: Sàn Giao Dịch Phân Quyền (DEX)", blocks: ["wallet", "gecko-chart", "gecko-txns", "uniswap-v3-sell"] },
    { id: "dao-voting", name: "🗳️ Bài 6: Bầu Cử Phi Tập Trung (DAO)", blocks: ["wallet", "dao-token-voting"] }
]
...
export const CATEGORIES = [
    ...
    { id: "nft", name: "🖼️ Nhóm Vật Phẩm", blocks: ["gacha-drop", "drop-gallery", "drop-airdrop", "profile-gallery"] },
    { id: "market", name: "📈 Nhóm Thị Trường", blocks: ["market-list", "market-cancel", "market-shop", "uniswap-v3-sell", "gecko-chart", "gecko-txns"] },
    { id: "dao", name: "🗳️ Nhóm Tổ Chức (DAO)", blocks: ["dao-token-voting"] }
]
