export const LESSONS = [
    ...
    { id: "token-factory", name: "🏭 Bài 7: Xưởng Tạo Token", blocks: ["wallet", "erc20-factory", "erc721-factory", "mint-nft", "balance"] }
]
...
export const CATEGORIES = [
    ...
    { id: "nft", name: "🖼️ Nhóm Vật Phẩm", blocks: ["erc721-factory", "mint-nft", "gacha-drop", "drop-gallery", "drop-airdrop", "profile-gallery"] },
